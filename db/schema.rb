...
ActiveRecord::Schema.define(version: 20_210_225_112_729) do
  ...
  create_table 'events', force: :cascade do |t|
    ...
    t.string 'time'
    t.string 'auth_token'
    t.index ['auth_token'], name: 'index_events_on_auth_token', unique: true
  ...
  create_table 'movie_suggestions', force: :cascade do |t|
    ...
    t.index ['event_id'], name: 'index_movie_suggestions_on_event_id'
    t.index ['movie_id'], name: 'index_movie_suggestions_on_movie_id'
  end
